...
pred_folders = list.files('Dec13_preds')#"Dec21_repeat_10_runs")
pred_folder = pred_folders[1]#"Predictions_Dec_20_RBF_C=0.655298078515272Y=0.585144090708118run8"#
print(pred_folder)
prediction_folder = paste("Dec13_preds/",pred_folder, sep="")
...
simp_full_data_list <- {}
pred_folders = list.files("Dec13_preds")
...
simp_full_data_list
write.csv(simp_full_data_list,'SVM_Mar11_cross_val_simplified_results.csv')
